...
export const IconCalendarFill = ({ className = "w-6 h-6" }: IconsSvgProps) => (
  <svg
    className={`${className}`}
    aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
...
export const IconSun = ({ className = "w-7 h-7" }: IconsSvgProps) => (
  <svg
    className={`${className}`}
    aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
...
export const IconCheck = ({ className = "w-6 h-6" }: IconsSvgProps) => (
  <svg
    className={`${className}`}
    aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
...
export const IconSearch = ({ className = "w-6 h-6" }: IconsSvgProps) => (
  <svg
    className={`${className}`}
    aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
...
export const IconMoon = ({ className = "w-7 h-7" }: IconsSvgProps) => (
  <svg
    className={`${className}`}
    aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
